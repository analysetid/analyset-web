...
1. **Brand Guideline / Design Brief ringkas**
   ...
   - Action item: taruh file PDF brand guideline ini di folder project (mis. `Analyset/brand/`) agar bisa diakses Hermes agent lain saat eksekusi.
